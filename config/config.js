module.exports = {
  clientId: "1044009132295995432", // The id of the discord bot
  guildId: "326325843187990528", // The id of the discord server
  mainColor: "f6c42f", // The hex color of the embeds by default
  lang: "main", // If you want to set english please set "main"


  openTicketChannelId: "1219205025784528957", // The id of the channel where the message to create a ticket will be sent
  ticketTypes: [ // You have a limit of 25 types (the limit of Discord)
    {
      ...
      categoryId: "1218958847050387497", // The category id where the tickets will be created
  ...
  roleToPingWhenOpenedId: "1219205563087458404", // The role to ping when a ticket is opened
  logs: true,
  logsChannelId: "1219206233479712809", // The id of the channel where the logs will be sent
  claimButton: true,
